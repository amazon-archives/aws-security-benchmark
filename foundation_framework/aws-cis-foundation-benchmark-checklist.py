...
def lambda_handler(event, context):
    ...
    control3[2] = control_3_2_ensure_log_metric_filter_console_signin_no_mfa(cloud_trails)
    control3[3] = control_3_3_ensure_log_metric_filter_root_usage(cloud_trails)
    control3[4] = control_3_4_ensure_log_metric_iam_policy_change(cloud_trails)
    control3[5] = control_3_5_ensure_log_metric_cloudtrail_configuration_changes(cloud_trails)
    control3[6] = control_3_6_ensure_log_metric_console_auth_failures(cloud_trails)
    control3[7] = control_3_7_ensure_log_metric_disabling_scheduled_delete_of_kms_cmk(cloud_trails)
    control3[8] = control_3_8_ensure_log_metric_s3_bucket_policy_changes(cloud_trails)
    control3[9] = control_3_9_ensure_log_metric_config_configuration_changes(cloud_trails)
    control3[10] = control_3_10_ensure_log_metric_security_group_changes(cloud_trails)
    control3[11] = control_3_11_ensure_log_metric_nacl(cloud_trails)
    control3[12] = control_3_12_ensure_log_metric_changes_to_network_gateways(cloud_trails)
    control3[13] = control_3_13_ensure_log_metric_changes_to_route_tables(cloud_trails)
    control3[14] = control_3_14_ensure_log_metric_changes_to_vpc(cloud_trails)
    control3[15] = control_3_15_verify_sns_subscribers()
